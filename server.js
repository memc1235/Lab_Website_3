...
app.get('/player_info/post', function(req, res){
	...
	var specific_player = "SELECT * FROM football_players WHERE id = '" + player + "';";
	var games_played = "SELECT count(*) FROM football_games WHERE players[1] = '" + player + "' OR players[2] = '" + player + "' OR players[3] = '" + player + "' OR players[4] = '" + player + "' OR players[5] = '" + player + "';";
	db.task('get-everything', task => {
		return task.batch([
